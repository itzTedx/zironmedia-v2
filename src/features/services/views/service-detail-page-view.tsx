		...
		<main>
			<section className="relative bg-[radial-gradient(ellipse_400%_240%_at_50%_100%,#fff,#fff_10%,15%,#c7c5fd_16%,rgba(154,103,250,.6)_17%,21%,#264cab_28%,35%,#00031d_45%,#00031d)]">
				<header className="dashed dashed-b relative w-full">
					<div className="md:dashed dashed-x container relative z-20 flex h-full max-w-7xl flex-col justify-end space-y-4 pt-12 pb-20 md:pt-20">
						<div className="mx-auto max-w-5xl space-y-4">
							<h1 className="font-display font-semibold text-4xl text-primary tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
								{service.metadata.title}
							</h1>
							<div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
								<p className="text-balance font-medium text-lg text-muted md:text-xl">
