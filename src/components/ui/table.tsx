...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
	return (
		<td
			className={cn(
				"p-3 align-top text-xs has-[[role=checkbox]]:pe-0 md:p-6 md:text-base *:[[role=checkbox]]:translate-y-0.5",
				className
			)}
